...
TARGET_OTA_ASSERT_DEVICE := oneplus5,cheeseburger,dumpling
...
TARGET_INIT_VENDOR_LIB := libinit_oneplus_oneplus5
TARGET_RECOVERY_DEVICE_MODULES := libinit_oneplus_oneplus5
