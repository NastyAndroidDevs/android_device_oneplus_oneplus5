...
# Audio
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/audio/mixer_paths_cheeseburger.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_cheeseburger.xml \
    $(LOCAL_PATH)/audio/mixer_paths_dumpling.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_dumpling.xml
